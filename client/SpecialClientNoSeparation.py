...
class SpecialClientNoSeparation(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        try:
            if config["mode"] == "per-cond":
                ...
                return self.fit_multi_cond(parameters, config)
    ...
    def fit_multi_cond(self, parameters, config):
        print('fit - special - multi-cond')
        train_data = DatasetLoader(self.cid, 'train').get_data()
